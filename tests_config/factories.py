...
class CategoryFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of Category model."""
...
class ProductFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of Product model."""
...
class ProductTypeFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of ProductType model
       and for ProductInventoryFactor."""
...
class BrandFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of Brand model
       and for ProductInventoryFactor."""
...
class ProductInventoryFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of ProductInventory model."""
...
class MediaFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of Media model."""
...
class StockFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of Stock model."""
...
class ProductAttributeFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of ProductAttribute model."""
...
class ProductAttributeValueFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of ProductAttributeValue model."""
...
class ProductAttributeValuesFactory(factory.django.DjangoModelFactory):
    """Factory for testing purposes of ProductAttributeValues model."""
