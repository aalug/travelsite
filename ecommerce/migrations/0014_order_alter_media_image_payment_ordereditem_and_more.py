# Generated by Django 4.1.1 on 2022-11-21 20:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ecommerce', '0013_alter_media_image'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='media',
            name='image',
            field=models.ImageField(help_text='format: required', upload_to='products/', verbose_name='product image'),
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('PayPal', 'PayPal'), ('Other Method', 'Other Method'), ('Different Method', 'Different Method')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_inventory', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ecommerce.productinventory')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
